...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState({
                phone: state => state.lead.phone || null,
                legal_name: state => state.lead.legal_name || null,
                dot_number: state => state.lead.dot_number || null,
                email_address: state => state.lead.email_address || null,
                dba_name: state => state.lead.dba_name || null,
                phy_street: state => state.lead.phy_street || null,
                phy_city: state => state.lead.phy_city || null,
                phy_zip: state => state.lead.phy_zip || null,
                phy_state: state => state.lead.phy_state || null,
                nbr_power_unit: state => state.lead.nbr_power_unit || null,
                driver_total: state => state.lead.driver_total || null,
                last_insurance_carrier: state => state.lead.last_insurance_carrier || null,
                last_insurance_date: state => state.lead.last_insurance_date || null,
                insurance_cancellation_date: state => state.lead.insurance_cancellation_date || null,
                comment: state => state.lead.comment || null,
                description: state => state.lead.description || null,
                dot_search: state => state.dot_search || null,
                phone_search: state => state.phone_search || null,
                first_name: state => state.lead.first_name || null,
                last_name: state => state.lead.last_name || null,
                full_time_employees: state => state.lead.full_time_employees || null,
                part_time_employees: state => state.lead.part_time_employees || null,
                currently_insured: state => state.lead.currently_insured || null,
                years_of_experience: state => state.lead.years_of_experience || null,
                legal_entity: state => state.lead.legal_entity || null,
                coverage_type: state => state.lead.coverage_type || null,
            })
        },
        components: {
            Datepicker,
