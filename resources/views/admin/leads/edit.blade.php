                ...
                <form method="POST" action="{{ route('leads.update', $lead->id) }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="last_insurance_date" name="last_insurance_date" value="{{ $lead->last_insurance_date }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="insurance_cancellation_date">Insurance Cancelation Date</label>
                            <input type="text" class="form-control" id="insurance_cancellation_date" name="insurance_cancellation_date" value="{{ $lead->insurance_cancellation_date }}">
                        </div>
                    </div>
